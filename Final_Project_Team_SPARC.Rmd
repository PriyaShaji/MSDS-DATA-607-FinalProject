...
All the project data sets, codes, and graphics are available under [Final Project repository](https://github.com/PriyaShaji/MSDS-DATA-607-FinalProject) on Github.

#### Rpub        

The presentation is published on [Final Project](http://rpubs.com/Priya_Shaji/data607final) Rpub.

#### Project Documentation 

All the project work and ideas were documented and available under [Project Documentation](https://github.com/PriyaShaji/MSDS-DATA-607-FinalProject) on Github.
...
```{r echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/PriyaShaji/MSDS-DATA-607-FinalProject/master/workflow.png")
```
...
The following is a sample of how the data was read from the respective sources. The full code on web scraping and database storage can be found at [Final Project Supporting Rmd](https://github.com/PriyaShaji/MSDS-DATA-607-FinalProject) on Github. 
...
train <- read_tsv("https://raw.githubusercontent.com/PriyaShaji/MSDS-DATA-607-FinalProject/master/Datasets/drugLibTrain_raw.tsv", col_names = TRUE, cols(
...
test <- read_tsv("https://raw.githubusercontent.com/PriyaShaji/MSDS-DATA-607-FinalProject/master/Datasets/drugLibTest_raw.tsv", col_names = TRUE, cols(
  X1 = col_double(),  urlDrugName = col_character(),  rating = col_double(),  effectiveness = col_factor(),  sideEffects = col_factor(),  condition = col_factor(),
  benefitsReview = col_character(),  sideEffectsReview = col_character(),  commentsReview = col_character()
))
...
> Diabetes Data Set
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
diabetes <- read_csv("https://raw.githubusercontent.com/PriyaShaji/MSDS-DATA-607-FinalProject/master/Datasets/diabetic_data.csv")
kable(head(diabetes)) %>%
  kable_styling() %>%
  scroll_box(width = "100%", height = "300px")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/PriyaShaji/MSDS-DATA-607-FinalProject/master/picture%201.png") 
...
knitr::include_graphics("https://raw.githubusercontent.com/PriyaShaji/MSDS-DATA-607-FinalProject/master/picture%202.png")
